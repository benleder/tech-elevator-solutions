...
<div id="confirmation-page">
	...
	<div id="order-data">
		<div id="shipping-info">
			...
			<p>
				${confirmationViewModel.order.getNameOnCard()} <br />
				${confirmationViewModel.order.getShippingAddress1()} <br />
				<c:if test="${not empty confirmationViewModel.order.getShippingAddress2()}">
					${confirmationViewModel.order.getShippingAddress2()} <br />
				</c:if>
 				${confirmationViewModel.order.getShippingCity()}, ${confirmationViewModel.order.getShippingState()} ${confirmationViewModel.order.getShippingPostalCode()} <br />
			</p>
		</div>
		<div id="payment-info">
			<h4>Payment Info</h4>
			****${confirmationViewModel.order.getCreditCardNumber().substring(confirmationViewModel.order.getCreditCardNumber().length()-4)} <br />
		</div>
