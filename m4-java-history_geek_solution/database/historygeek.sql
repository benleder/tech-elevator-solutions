...
', CAST(8.99 AS DECIMAL(5, 2)), 'def-5678.jpg', CAST(8.80 AS DECIMAL(5, 2)), TRUE);

INSERT INTO products (sku, name, description, price, imageName, weight, active)  VALUES ('GHI-9123', 'Theodore Roosevelt Plush Doll', 'TR was a conservationist who took steps to preserve natural wonders such as the Grand Canyon, though he failed to champion the people from whom the continent was "won." Theodore Roosevelt bristled with contradictions! He was a privileged and sickly child who refashioned himself into a rowdy intellectual who took on the powerful and the moneyed on behalf of the people. Now this man who was immortalized on Mount Rushmore (a/k/a Six Grandfathers) is immortalized as a cuddly 11" Little Thinker doll!', CAST(9.25 AS DECIMAL(5, 2)), 'ghi-9123.jpg', CAST(8.20 AS DECIMAL(5, 2)), TRUE);

INSERT INTO products (sku, name, description, price, imageName, weight, active)  VALUES ('JKL-4567', 'George Washington Plush Doll', 'Have you ever wanted to hug the father of our country? In real life, George Washington was known to be a hugger. Washington hugged his pal, Lafayette, who was a major-general in the Revolutionary War. On his way to resign his commission, Washington wept unashamedly and embraced each of his officers in appreciation for their camaraderie.', CAST(12.99 AS DECIMAL(5, 2)), 'jkl-4567.jpg', CAST(11.10 AS DECIMAL(5, 2)), TRUE);
